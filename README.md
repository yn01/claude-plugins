...
### [jev-gate](./plugins/jev-gate) `v0.2.4`
...
### 2026-09-23
- Add **jev-gate** v0.2.4 — stop-event gate judged by Jev (TypeSafe System One); completion-evidence and early-stop detection, Shadow Mode by default, JSONL verdict journal, `/jev-gate:status` `/jev-gate:mode` `/jev-gate:doctor`
